Included base files for project, however was limited due to package file size "venv" which would hold all the packages needded to run this program; flask, yfinance, matplotlib etc. 
